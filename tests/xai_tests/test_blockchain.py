...
class TestBlockchainCore:
    ...
    def test_blockchain_initialization(self, tmp_path):
        ...
        assert bc.initial_block_reward == 12.0, "Initial block reward should be 12 AXN"

    def test_genesis_block(self, tmp_path):
    ...
    def test_block_mining(self, tmp_path):
    ...
    def test_transaction_creation(self, tmp_path):
    ...
    def test_transaction_validation(self, tmp_path):
    ...
    def test_balance_tracking(self, tmp_path):
    ...
    def test_chain_validation(self, tmp_path):
    ...
    def test_supply_cap_enforcement(self, tmp_path):
    ...
    def test_halving_schedule(self, tmp_path):
