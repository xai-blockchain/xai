...
class TestNodeAPIPeerRoutes:
    ...
    def test_receive_transaction_success(self, client, mock_node):
        ...
        response = client.post(
            '/transaction/receive', data=json.dumps(payload), content_type='application/json'
        )
    ...
    def test_receive_transaction_invalid_payload(self, client):
        """Test POST /transaction/receive - invalid payload rejected."""
        response = client.post('/transaction/receive', data=json.dumps({}), content_type='application/json')
        assert response.status_code == 400
    ...
    def test_receive_block_success(self, client, mock_node):
        ...
        response = client.post(
            '/block/receive', data=json.dumps(payload), content_type='application/json'
        )
    ...
    def test_receive_block_invalid_payload(self, client):
        """Test POST /block/receive - invalid payload rejected."""
        response = client.post('/block/receive', data=json.dumps({}), content_type='application/json')
        assert response.status_code == 400
...
class TestNodeAPIAlgorithmicRoutes:
    ...
    def test_check_fraud(self, client):
        ...
        tx_data = {"sender": "addr1", "amount": 100}
...
class TestNodeAPIGamificationRoutes:
    ...
    def test_create_treasure_requires_api_key(self, mock_node, monkeypatch):
        ...
        payload = {
            ...
            "amount": 25.0,
            "puzzle_type": "riddle",
            "puzzle_data": "What walks on four legs...",
        }
