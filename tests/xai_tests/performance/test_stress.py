...
class TestBlockchainScalability:
    ...
    def test_large_chain_validation(self, tmp_path):
    ...
    def test_many_transactions_per_block(self, tmp_path):
    ...
    def test_utxo_set_growth(self, tmp_path):
...
class TestTransactionThroughput:
    ...
    def test_transaction_creation_speed(self, tmp_path):
        ...
        for recipient in recipients:
            tx = bc.create_transaction(
                sender.address, recipient.address, 1.0, 0.24, sender.private_key, sender.public_key
            )
    ...
    def test_signature_verification_speed(self, tmp_path):
...
class TestConcurrency:
    ...
    def test_concurrent_balance_queries(self, tmp_path):
...
class TestMemoryUsage:
    ...
    def test_chain_memory_growth(self, tmp_path):
    ...
    def test_utxo_set_memory(self, tmp_path):
    ...
    def test_mempool_memory(self, tmp_path):
...
class TestStressConditions:
    ...
    def test_rapid_block_mining(self, tmp_path):
    ...
    def test_transaction_spam(self, tmp_path):
        ...
        for victim in victims:
            tx = bc.create_transaction(
                spammer.address, victim.address, 0.01, 0.01, spammer.private_key, spammer.public_key
            )
            bc.add_transaction(tx)
            spam_count += 1
    ...
    def test_large_transaction_batch(self, tmp_path):
...
class TestLongRunning:
    ...
    def test_extended_mining_session(self, tmp_path):
    ...
    def test_chain_resilience(self, tmp_path):
