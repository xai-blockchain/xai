...
class TestGovernanceFlow:
    ...
    def test_basic_governance_participation(self, e2e_blockchain_dir):
        ...
        blockchain.mine_pending_transactions(participant.address, miner_identity(participant))
    ...
    def test_governance_proposal_submission(self, e2e_blockchain_dir):
        ...
        # Fund proposer
        blockchain.mine_pending_transactions(proposer.address, miner_identity(proposer))
    ...
    def test_governance_voting_power_calculation(self, e2e_blockchain_dir):
        ...
        for _ in range(3):
            blockchain.mine_pending_transactions(wallet1.address, miner_identity(wallet1))

        # Fund wallet2 with less
        blockchain.mine_pending_transactions(wallet2.address, miner_identity(wallet2))
    ...
    def test_governance_stake_based_voting(self, e2e_blockchain_dir):
        ...
        for _ in range(10):
            blockchain.mine_pending_transactions(whale.address, miner_identity(whale))

        # Small holder holds small amount
        blockchain.mine_pending_transactions(small_holder.address, miner_identity(small_holder))
    ...
    def test_governance_delegation_preparation(self, e2e_blockchain_dir):
        ...
        # Fund both wallets
        blockchain.mine_pending_transactions(delegator.address, miner_identity(delegator))
        blockchain.mine_pending_transactions(delegate.address, miner_identity(delegate))
    ...
    def test_governance_voting_power_weighted(self, e2e_blockchain_dir):
        ...
        for voter, weight in zip(voters, voter_weights):
            for _ in range(weight):
                blockchain.mine_pending_transactions(voter.address, miner_identity(voter))
