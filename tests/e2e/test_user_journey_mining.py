...
class TestUserJourneyMining:
    ...
    def test_user_starts_mining_node(self, e2e_blockchain_dir):
        ...
        # User starts mining
        block = blockchain.mine_pending_transactions(miner_wallet.address, miner_identity(miner_wallet))
    ...
    def test_user_mining_with_pending_transactions(self, e2e_blockchain_dir):
        ...
        # Fund sender
        blockchain.mine_pending_transactions(sender.address, miner_identity(sender))
        ...
        block = blockchain.mine_pending_transactions(miner.address, miner_identity(miner))
    ...
    def test_user_mining_with_node_api(self, e2e_blockchain_dir):
        ...
        block = blockchain.mine_pending_transactions(node.miner_address, miner_identity(miner_wallet))
        assert block is not None
