...
from aixn.core.token_burning_engine import TokenBurningEngine, ServiceType, SERVICE_PRICES_USD
...
class TestBurnStatistics:
    ...
    def test_service_usage_breakdown(self, burning_engine):
        ...
        engine.consume_service("AIXN123...", ServiceType.AI_QUERY_SIMPLE)
