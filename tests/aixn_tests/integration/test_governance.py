...
class TestVotingPower:
    ...
    def test_voting_power_display(self):
    ...
    def test_voter_type_weight(self):
    ...
    def test_hybrid_voter_bonus(self):
...
class TestProposalExecution:
    ...
    def test_proposal_passes_with_majority(self):
...
class TestGovernanceIntegration:
    ...
    def test_proposal_on_blockchain(self):
    ...
    def test_voting_with_blockchain_verification(self):
    ...
    def test_governance_transaction_type(self):
...
class TestGovernanceParameters:
    ...
    def test_parameter_change_proposal(self):
