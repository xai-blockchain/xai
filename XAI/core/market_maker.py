...
class MarketMaker:
    ...
    def __init__(self, node_url: str, maker_address: str):
        ...
        # Trading pairs - AXN paired with all supported currencies
        self.pairs = [
            'AXN/USD',  # Fiat
            'AXN/BTC', 'AXN/ETH', 'AXN/USDT',  # Major crypto
            'AXN/LTC', 'AXN/BNB',  # Altcoins
            'AXN/SOL', 'AXN/XRP', 'AXN/DOGE',  # Popular coins
            'AXN/SHIB', 'AXN/MATIC', 'AXN/DOT',  # Trending coins
            'AXN/AVAX', 'AXN/LINK', 'AXN/UNI', 'AXN/ADA'  # DeFi & platforms
        ]
