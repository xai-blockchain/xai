...
|-----------|---------|----------|--------|
| Coverage Enforcement Workflow | GitHub Actions workflow for PR coverage checks | `.github/workflows/coverage-enforcement.yml` | ✅ Ready |
...
The `.github/workflows/coverage-enforcement.yml` file provides:
...
Modify in `.github/workflows/coverage-enforcement.yml` as needed.
...
.github/workflows/
└── coverage-enforcement.yml           # GitHub Actions workflow
