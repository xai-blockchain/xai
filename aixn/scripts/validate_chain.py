...
from core.blockchain_loader import load_blockchain_with_validation, BlockchainLoader
...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=121000000.0,
        help='Maximum supply cap (default: 121M)'
    )
    parser.add_argument(
        '--genesis-hash',
        type=str,
        default=None,
        help='Expected genesis hash for strict validation'
    )
    ...
    try:
        ...
        success, blockchain_data, message = loader.load_and_validate(
