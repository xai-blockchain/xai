...
class OFACBlacklist(BlacklistSource):
    ...
    def fetch_addresses(self) -> Set[str]:
        ...
        Not executed during development/testing
        """
        # REAL implementation (nodes execute this):
        """
        import requests
...
class CommunityBlacklist(BlacklistSource):
    ...
    def fetch_addresses(self) -> Set[str]:
        ...
        NOTE: Not executed during testing
        """
        # REAL implementation:
        """
        import requests
        ...
        for entry in data.get('blacklisted_addresses', []):
            # Require minimum vote threshold
            if entry.get('votes', 0) >= 7:  # 7 of 11 founders must approve
