...
from core.token_burning_engine import TokenBurningEngine, ServiceType
from core.anonymous_treasury import AnonymousTreasury
...
def setup_burning_api(app, node):
    ...
    def get_service_price(service_type):
        ...
        from core.token_burning_engine import SERVICE_PRICES_USD
