...
try:
    from core.enhanced_voting_system import EnhancedVotingSystem
    from core.ai_node_operator_questioning import AINodeOperatorQuestioning
    from core.multi_ai_collaboration import MultiAICollaboration
    from core.ai_task_matcher import AITaskMatcher
...
try:
    from core.ai_trading_bot import AITradingBot, TradingStrategy, STRATEGY_TEMPLATES
...
class IntegratedXAINode:
    ...
    def __init__(self, host=None, port=None, miner_address=None):
        ...
        try:
            from core.ai_safety_controls import AISafetyControls
        ...
        try:
            from core.time_capsule_api import add_time_capsule_routes
        ...
        try:
            from core.ai_safety_controls_api import add_safety_control_routes
