...
### ✓ Wallet Addresses
```
AIXN7f3a9c2e1b8d4f6a5c9e2d1f8b4a7c3e9d2f1b
```
...
```python
{
  ...
  'wallet_address': 'AIXN...',  # Anonymous address only
  'service_type': 'ai_query_simple',
  'burned_xai': 0.05,
...
```python
{
  'locked_address': 'AIXN...',  # Anonymous wallet
  'locked_amount': 500.0,
...
```python
{
  ...
  'proposer_address': 'AIXN...',  # Anonymous wallet
...
```python
{
  'miner_address': 'AIXN...',  # Anonymous wallet
  'block_height': 12345,
  'reward': 12.0,
  'timestamp_utc': 1699564800.0
}
...
**GOOD (Anonymous):**
```python
print(f"[Burn] 0.05 XAI burned from wallet AIXN...abc123")
...
```markdown
Example:
  wallet_address: "AIXN7f3a9c2e1b8d4f6a5c9e2d1f8b4a7c3e9d2f1b"
