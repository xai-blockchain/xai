...
class GovernanceCapabilityRegistry:
    ...
    def __init__(self):
        ...
        self.registered_proposal_types = {
            ...
            ProposalType.ADD_PARAMETER.value: {
                ...
                'required_fields': ['parameter_name', 'parameter_type', 'min_value', 'max_value', 'default_value'],
                'enabled': True
            },
    ...
    def add_parameter(self, name: str, param_type: ParameterType, min_val: Any,
                     max_val: Any, default_val: Any, description: str) -> bool:
        """
    ...
    def add_proposal_type(self, type_name: str, description: str,
...
class GovernanceExecutionEngine:
    ...
    def _execute_protocol_parameter(self, proposal_id: str, proposal_data: Dict) -> Dict:
        ...
        # Log execution
        self._log_execution(proposal_id, 'protocol_parameter', {
            'parameter': parameter,
            'old_value': old_value,
            'new_value': new_value
        })
    ...
    def _execute_feature_activation(self, proposal_id: str, proposal_data: Dict) -> Dict:
        ...
        # Log execution
        self._log_execution(proposal_id, 'feature_activation', {
    ...
    def _execute_treasury_allocation(self, proposal_id: str, proposal_data: Dict) -> Dict:
        ...
        # Log execution
        self._log_execution(proposal_id, 'treasury_allocation', {
            'recipient': recipient,
            'amount': amount,
            'purpose': purpose,
    ...
    def _execute_emergency_action(self, proposal_id: str, proposal_data: Dict) -> Dict:
        ...
        can_execute, error = self.blockchain.security_manager.emergency_timelock.can_execute_emergency_action(
            proposal_id,
            current_height
        )
        ...
        if action_type == 'pause_transactions':
            ...
            return {
                'success': False,
                'error': f'Unknown emergency action: {action_type}'
            }

        # Log execution
        self._log_execution(proposal_id, 'emergency_action', {
    ...
    def _execute_add_proposal_type(self, proposal_id: str, proposal_data: Dict) -> Dict:
        ...
        if not success:
            return {
                'success': False,
                'error': f'Proposal type {type_name} already exists'
            }

        # Log execution
        self._log_execution(proposal_id, 'add_proposal_type', {
            'type_name': type_name,
            'description': description,
            'required_fields': required_fields
        })
    ...
    def _execute_add_parameter(self, proposal_id: str, proposal_data: Dict) -> Dict:
        ...
        if not success:
            return {
                'success': False,
                'error': f'Parameter {param_name} already exists'
            }

        # Log execution
        self._log_execution(proposal_id, 'add_parameter', {
    ...
    def _execute_modify_governance_rules(self, proposal_id: str, proposal_data: Dict) -> Dict:
        ...
        if rule_name == 'min_voters':
            ...
            return {
                'success': False,
                'error': f'Unknown governance rule: {rule_name}'
            }

        # Log execution
        self._log_execution(proposal_id, 'modify_governance_rules', {
            'rule_name': rule_name,
            'old_value': old_value,
            'new_value': new_value
        })
    ...
    def _execute_custom_proposal(self, proposal_id: str, proposal_data: Dict) -> Dict:
        ...
        self._log_execution(proposal_id, 'custom_proposal', {
