...
from aixn.core.api_mining import MiningAPIHandler
from aixn.core.api_governance import GovernanceAPIHandler
from aixn.core.api_wallet import WalletAPIHandler
from aixn.core.api_ai import AIAPIHandler
from aixn.core.api_websocket import WebSocketAPIHandler
...
class APIExtensions:
    ...
    def __init__(self, node: Any):
        ...
        self.mining_handler = MiningAPIHandler(
            node, self.app, self.websocket_handler.broadcast_ws
        )
