...
class APIExtensions:
    ...
    def setup_mining_routes(self):
        ...
        def mining_status():
            ...
            if not is_mining:
                return jsonify({"is_mining": False, "miner_address": miner_address})
    ...
    def setup_governance_routes(self):
        ...
        def submit_proposal():
            ...
            proposal_id = hashlib.sha256(f"{time.time()}{data.get('title')}".encode()).hexdigest()[
                :16
            ]
        ...
        def get_proposals():
            ...
            return jsonify({"count": 0, "proposals": []})
    ...
    def setup_questioning_routes(self):
        ...
        def get_pending_questions():
            ...
            return jsonify({"count": 0, "questions": []})
    ...
    def setup_wallet_routes(self):
        ...
        def create_embedded_wallet():
            ...
            try:
                record = self.node.account_abstraction.create_embedded_wallet(
                    alias, contact, secret
                )
    ...
    def setup_wallet_trades_routes(self):
        ...
        def walletconnect_handshake():
            ...
            handshake = self.node.blockchain.trade_manager.begin_walletconnect_handshake(
                wallet_address
            )
        ...
        def wallet_seeds_snapshot():
            ...
            with open(summary_path, "r") as f:
                summary = json.load(f)
            return jsonify({"success": True, "manifest": manifest, "summary": summary})
        ...
        def gossip_trade_event():
            ...
            if result.get("success"):
                self.broadcast_ws({"channel": "wallet-trades", "event": "gossip", "data": event})
            return jsonify(result)
    ...
    def setup_personal_ai_routes(self):
        ...
        def personal_ai_assistants():
            ...
            return jsonify({"success": True, "assistants": assistant_layer.list_micro_assistants()})
