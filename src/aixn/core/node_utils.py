"""
AIXN Blockchain Node Utilities
...
ALGO_FEATURES_ENABLED: bool = False  # Algorithmic features toggle
NODE_VERSION: str = "2.0.0"
DEFAULT_HOST: str = "0.0.0.0"
DEFAULT_PORT: int = 8545
...
def get_allowed_origins() -> List[str]:
    ...
    Example:
        ...
        >>> print(origins)
        ['http://localhost:3000', 'https://app.aixn.io']
    """
    cors_config_path = os.path.join(
        os.path.dirname(__file__), "..", "..", "config", "cors.yaml"
    )
