...
class TimeLockRelease:
    ...
    def __init__(self, component: str, code: str, activation_timestamp: int,
    ...
    def to_public_dict(self) -> Dict:
        ...
        return {
            ...
            'code_hash': self.code_hash,
            'days_until_activation': (self.activation_timestamp - time.time()) / 86400 if not self.is_active() else 0
        }
...
if __name__ == "__main__":
    ...
    for release in genesis_releases:
        ...
        activation_date = datetime.fromtimestamp(release['activation_timestamp']).strftime('%Y-%m-%d')
