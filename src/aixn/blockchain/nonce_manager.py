...
class NonceManager:
    ...
    def check_and_increment_nonce(self, sender_address: str, incoming_nonce: int) -> bool:
        ...
        if incoming_nonce == expected_nonce:
            ...
            print(f"Nonce for {sender_address} is too high (incoming: {incoming_nonce}, expected: {expected_nonce}). "
            ...
            print(f"Nonce for {sender_address} is too low (incoming: {incoming_nonce}, expected: {expected_nonce}). "
