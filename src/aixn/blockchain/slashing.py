...
class SlashingManager:
    ...
    def report_malicious_behavior(self, validator_address: str, offense_type: str):
        ...
        if slash_amount == 0 and penalty_percentage > 0: # Ensure at least 1 unit is slashed if penalty > 0
        ...
        if slash_amount > 0:
            ...
            print(f"Slashing event: Validator {validator_address} slashed {slash_amount} for '{offense_type}'.")
...
if __name__ == "__main__":
    ...
    slashing_manager.report_malicious_behavior("0xValidatorD", "unknown_offense") # Non-existent validator
