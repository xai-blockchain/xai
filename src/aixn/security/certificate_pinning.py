...
if __name__ == "__main__":
    ...
    print("\nAttempting connection to aixn.network with one of the correct pins:")
    is_valid_aixn = pinner.verify_connection("aixn.network", aixn_api_spki_hash)
    print(f"Connection to aixn.network valid: {is_valid_aixn}")
