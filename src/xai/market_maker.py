...
class MarketMaker:
    ...
    def calculate_order_levels(self, pair: str = "AXN/USD") -> dict:
        ...
        for i in range(self.num_levels):
            ...
            buy_amount = random.uniform(float(self.order_size_min), float(self.order_size_max))
            buy_levels.append(
                {
            ...
            sell_amount = random.uniform(float(self.order_size_min), float(self.order_size_max))
            sell_levels.append(
                {
    ...
    def place_liquidity_orders(self, pair: str = "AXN/USD") -> dict:
        ...
        placed_orders = {"buy": [], "sell": [], "total_usd_locked": 0, "total_axn_locked": 0}
    ...
    def get_current_orders(self) -> list[dict]:
        ...
        try:
            response = requests.get(
                f"{self.node_url}/exchange/my-orders/{self.maker_address}", timeout=5
            )
