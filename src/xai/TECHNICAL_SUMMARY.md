...
- **Address Prefix**: Mainnet: "XAI", Testnet: "TXAI"
...
- `validate_address()`: Length check, prefix validation (XAI/TXAI)
...
- Address truncation: First 6 + last 4 chars (e.g., "XAI12...ab34")
...
**Burn Mechanism**:
- User sends XAI to null address: `XAI_BURN_000000000000000000000000000000000000`
...
- Burn address: `XAI_BURN_000000000000000000000000000000000000`
...
**Cryptography**:
- cryptography: secp256k1 signatures
