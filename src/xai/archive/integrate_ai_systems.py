...
class IntegratedXAINode:
    ...
    def __init__(self, host=None, port=None, miner_address=None):
        ...
        host = host or os.getenv("XAI_HOST", "127.0.0.1")
        ...
        if host == "0.0.0.0":
            ...
            warnings.warn(
                ...
                "Set to specific IP address (e.g., 127.0.0.1 or your server IP)",
                SecurityWarning,
                stacklevel=2
            )
        print("\n" + "=" * 80)
        ...
        try:
            from src.xai.core.ai_safety_controls import AISafetyControls
        ...
        try:
            from src.xai.core.time_capsule_api import add_time_capsule_routes
        ...
        try:
            from src.xai.core.ai_safety_controls_api import add_safety_control_routes
