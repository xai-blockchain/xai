...
class NodeConnectionManager:
    def __init__(
        ...
        security_manager: Optional[P2PSecurityManager] = None,
    ):
    ...
    def handle_inbound_connection(self, peer_info: Any) -> str:
        """
    ...
    def validate_peer_message(self, peer_url: str, message_data: bytes, message: Dict[str, Any]) -> bool:
        """
...
if __name__ == "__main__":
    ...
    in_conn_1 = manager.handle_inbound_connection("peer_A_info")
