...
class SecurityValidator:
    ...
    def validate_address(address: Any, field_name: str = "address") -> str:
        ...
        from xai.core.consensus.validation import AddressFormatValidator
    ...
    def validate_fee(fee: Any) -> float:
        ...
        Raises:
            ValidationError: If validation fails
        """
        from xai.core.consensus.validation import validate_fee as core_validate_fee
    ...
    def validate_string(value: Any, field_name: str = "value", max_length: int = None) -> str:
        ...
        Raises:
            ValidationError: If validation fails
        """
        from xai.core.consensus.validation import validate_string as core_validate_string
    ...
    def validate_positive_integer(value: Any, field_name: str = "value") -> int:
        ...
        Raises:
            ValidationError: If validation fails
        """
        from xai.core.consensus.validation import validate_positive_integer as core_validate_positive_integer
    ...
    def validate_hex_string(value: Any, field_name: str = "value", exact_length: int = None) -> str:
        ...
        Raises:
            ValidationError: If validation fails
        """
        from xai.core.consensus.validation import validate_hex_string as core_validate_hex_string
