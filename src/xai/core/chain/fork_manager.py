...
Supports Protocol-based dependency injection for testability:
    ...
    - Can accept any object implementing ChainProvider, ValidationProvider
"""
...
if TYPE_CHECKING:
    ...
    from xai.core.manager_interfaces import ChainProvider, StateProvider, ValidationProvider
