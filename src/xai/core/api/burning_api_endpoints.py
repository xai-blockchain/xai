...
from xai.core.governance.anonymous_treasury import AnonymousTreasury
from xai.core.governance.token_burning_engine import ServiceType, TokenBurningEngine
...
def setup_burning_api(app: Any, node: Any) -> TokenBurningEngine:
    ...
    def get_service_price(service_type: str) -> tuple[Response, int] | Response:
        ...
        from xai.core.governance.token_burning_engine import SERVICE_PRICES_USD
