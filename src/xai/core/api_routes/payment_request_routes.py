"""Payment request tracking and verification API routes.

This module provides REST API endpoints for creating tracked payment requests,
checking payment status, parsing payment URIs, and verifying payments.
...
def register_payment_request_routes(routes: "NodeAPIRoutes") -> None:
    """Register payment request tracking and verification routes.
    ...
    def get_payment_request(request_id: str) -> tuple[Response, int]:
        ...
        Returns:
            JSON response (200 OK):
            {
                ...
                "paid_txid": "txid...",          # If status=paid
                "paid_at": 1703000500            # If status=paid
            }
    ...
    def parse_payment_uri() -> tuple[Response, int]:
        ...
        Returns:
            JSON response (200 OK):
            {
                ...
                "expires_at": 1703001234,      # Optional
                "valid": true,
                "expired": false
            }
