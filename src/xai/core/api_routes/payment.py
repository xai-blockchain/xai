...
This module provides REST API endpoints for generating QR codes for payment requests,
tracking payment request status, and parsing payment URIs. It leverages the existing
QR code generation infrastructure from xai.mobile.qr_transactions.
