...
Supports Protocol-based dependency injection for testability:
    ...
    - Can accept any object implementing ValidationProvider, ConfigProvider
"""
...
class ValidationManager:
    ...
    def __init__(self, blockchain: "Blockchain") -> None:
        """
        Initialize ValidationManager with reference to blockchain or protocol provider.

        Supports Protocol-based dependency injection for better testability.
        Accepts any object that provides the required validation methods:
        - Chain access (chain, storage.load_block_from_disk)
        - Config access (difficulty, difficulty_adjustment_interval)
        - Validation access (transaction_validator, calculate_next_difficulty)
        - Timestamp access (_max_future_block_time, _median_time_span)
