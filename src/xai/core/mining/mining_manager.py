...
Supports Protocol-based dependency injection for testability:
    ...
    - Can accept any object implementing ConfigProvider, ChainProvider, MiningProvider
"""
...
class MiningManager:
    ...
    def __init__(self, blockchain: "Blockchain") -> None:
        """
        Initialize MiningManager with reference to blockchain or protocol provider.

        Supports Protocol-based dependency injection for better testability.
        Accepts any object that provides the required mining methods:
        - Chain access (chain, get_latest_block, add_block)
        - Config access (difficulty, get_block_reward, _prioritize_transactions)
        - Mining access (fast_mining_enabled, max_test_mining_difficulty)
        - Gamification access (airdrop_manager, streak_tracker, etc.)
